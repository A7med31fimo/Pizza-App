      ...
      <View style={styles.categories}>
        <ScrollView horizontal={true}>
          ...
          <TouchableOpacity onPress={clickFav}>
            ...
            <Text style={{ color: ColorCard, textAlign: "center" }}>{ auth.currentUser!==null? auth.currentUser.displayName==="admin"?"adminlist":"Favourite":null}</Text>
          </TouchableOpacity>
      ...
      <View style={styles.container}>
        <ScrollView style={{ backgroundColor: "#FFF" }}>
          {Page === 0 ? (
            ...
            <View>
              {auth.currentUser.displayName==="admin"?<ChatAdmin/>:<FavPage  fuc1 = {menu}/>}
            </View>
          ):
          <View>
          <Confirmation/>
